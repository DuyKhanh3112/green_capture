...
import 'package:green_capture/widgets/dialog/dialog_date_picker_range.dart';
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  TextButton(
                      onPressed: () async =>
                          await homeController.deleteFilter(),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: DropdownButtonFormField(
        ...
        onChanged: (value) =>
            homeController.plantTypeSelectedFilter.value = value,
      ),
    );
  }
}
